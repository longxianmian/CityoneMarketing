    ...
    () => [
      ...
      // === 3. 站点管理 ===
      {
        ...
        children: [
          ...
          { key: '/admin/growth/station-benefits', label: lt('stationBenefits') },
      ...
      // === 4. 福利中心 ===
      {
        ...
        children: [
          ...
          { key: '/admin/growth/points/mall', label: lt('benefitGroup') },
      ...
      // === 5. AI Agent ===
      {
        ...
        children: [
          ...
          { key: '/admin/agent/biz', label: lt('agentBizManage') },
          ...
          { key: '/admin/growth/agent/intent-tester', label: lt('intentTester') },
